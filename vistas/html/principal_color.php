...
<script src="http://localhost/poscomercial/vistas//html/js/loader.js"></script>
             ...
             <a href="cxp.php">
              <div class="widget-bg-color-icon card-box" >
                ...
                <div class="text-right">
                  ...
                  <p class="text-muted mb-0">Cta. Por Pagar</p>
                </div>
             ...
             <a href="cxc.php">
              <div class="widget-bg-color-icon card-box" >
                ...
                <div class="text-right">
                  ...
                  <p class="text-muted mb-0">Cta. Por Cobrar</p>
                </div>
                <div class="clearfix"></div>
              </div>
              </a>
 ...
 <div class="col-lg-6 col-xl-2">
            <a href="cxc.php">
              <div class="widget-bg-color-icon card-box" >
                ...
                <div class="text-right">
                  <h5 class="text-dark text-center"><b class="counter text-pink"><?php total_creditos();?></b></h5>
                  <p class="text-muted mb-0">Pago Créditos</p>
                </div>
                <div class="clearfix"></div>
              </div>
              </a>
	 ...
	 <div class="col-lg-6 col-xl-2">
            <a href="cxc.php">
              <div class="widget-bg-color-icon card-box" >
                ...
                <div class="text-right">
                  <h5 class="text-dark text-center"><b class="counter text-pink"><?php total_creditos();?></b></h5>
                  <p class="text-muted mb-0">Total Créditos</p>
                </div>
                <div class="clearfix"></div>
              </div>
              </a>
